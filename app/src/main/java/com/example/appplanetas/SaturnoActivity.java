...
public class SaturnoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBarSaturno);
        ...
        buttonCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pesoString.isEmpty()) {
                    Toast.makeText(SaturnoActivity.this, "Por favor, digite um valor.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void alterarPeso() {
        resultado.setText(String.format("Em Saturno, seria %.2f kg.", model.getPesoCalculado()));
    }
}