...
public class Mercurio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBarMercurio);
        ...
        buttonCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pesoString.isEmpty()) {
                    Toast.makeText(Mercurio.this, "Por favor, digite um valor.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void alterarPeso() {
        resultado.setText(String.format("Em Mercúrio, seria %.2f kg.", model.getPesoCalculado()));
    }
