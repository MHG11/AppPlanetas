...
public class JupiterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBarJupiter);
        ...
        buttonCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pesoString.isEmpty()) {
                    Toast.makeText(JupiterActivity.this, "Por favor, digite um valor.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void alterarPeso() {
        resultado.setText(String.format("Em Jupiter, seria %.2f kg.", model.getPesoCalculado()));
    }
}