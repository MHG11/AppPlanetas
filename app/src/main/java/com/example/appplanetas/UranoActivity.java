...
public class UranoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBarUrano);
        ...
        buttonCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pesoString.isEmpty()) {
                    Toast.makeText(UranoActivity.this, "Por favor, digite um valor.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void alterarPeso() {
        resultado.setText(String.format("Em Urano, seria %.2f kg.", model.getPesoCalculado()));
    }
}