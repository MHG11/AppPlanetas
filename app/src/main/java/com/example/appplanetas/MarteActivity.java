...
public class MarteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBarMarte);
        ...
        buttonCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pesoString.isEmpty()) {
                    Toast.makeText(MarteActivity.this, "Por favor, digite um valor.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void alterarPeso() {
        resultado.setText(String.format("Em Marte, seria %.2f kg.", model.getPesoCalculado()));
    }
}